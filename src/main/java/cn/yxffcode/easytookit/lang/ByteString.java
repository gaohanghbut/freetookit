...
public class ByteString {
    protected interface ByteStringFactory {
        ByteString newInstance(byte[] value,
                               int start,
                               int length,
                               boolean copy);
    }
    ...
    private static final   ByteStringFactory DEFAULT_FACTORY = new ByteStringFactory() {
        @Override
        public ByteString newInstance(byte[] value,
                                      int start,
                                      int length,
                                      boolean copy) {
    ...
    public ByteString(ByteString value,
                      boolean copy) {
    ...
    public ByteString(CharSequence value,
                      Charset charset) {
        this(value, charset, 0, checkNotNull(value, "value").length());
    }
    ...
    protected ByteString subSequence(int start,
                                     int end,
                                     boolean copy,
