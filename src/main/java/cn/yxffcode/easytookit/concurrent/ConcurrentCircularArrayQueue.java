...
public abstract class ConcurrentCircularArrayQueue<E> extends ConcurrentCircularArrayQueueL0Pad<E> {
    ...
    static {
        final int scale = UnsafeUtils.UNSAFE.arrayIndexScale(Object[].class);
        if (4 == scale) {
            REF_ELEMENT_SHIFT = 2;
        } else if (8 == scale) {
            REF_ELEMENT_SHIFT = 3;
        ...
        REF_ARRAY_BASE = UnsafeUtils.UNSAFE.arrayBaseOffset(Object[].class) + (REF_BUFFER_PAD * scale);
    }
    ...
    protected static final <E> void spElement(E[] buffer, long offset, E e) {
        UnsafeUtils.UNSAFE.putObject(buffer, offset, e);
    }
    ...
    protected static final <E> void soElement(E[] buffer, long offset, E e) {
        UnsafeUtils.UNSAFE.putOrderedObject(buffer, offset, e);
    }
    ...
    protected static final <E> E lpElement(E[] buffer, long offset) {
        return (E) UnsafeUtils.UNSAFE.getObject(buffer, offset);
    }
    ...
    protected static final <E> E lvElement(E[] buffer, long offset) {
        return (E) UnsafeUtils.UNSAFE.getObjectVolatile(buffer, offset);
    }
