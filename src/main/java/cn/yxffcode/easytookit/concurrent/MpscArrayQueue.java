...
abstract class MpscArrayQueueTailField<E> extends MpscArrayQueueL1Pad<E> {
    ...
    static {
        try {
            P_INDEX_OFFSET = UnsafeUtils.UNSAFE.objectFieldOffset(MpscArrayQueueTailField.class
    ...
    protected final boolean casProducerIndex(long expect,
                                             long newValue) {
        return UnsafeUtils.UNSAFE.compareAndSwapLong(this, P_INDEX_OFFSET, expect, newValue);
    }
}
...
abstract class MpscArrayQueueConsumerField<E> extends MpscArrayQueueL2Pad<E> {
    ...
    static {
        try {
            C_INDEX_OFFSET = UnsafeUtils.UNSAFE.objectFieldOffset(MpscArrayQueueConsumerField.class
    ...
    protected void soConsumerIndex(long l) {
        UnsafeUtils.UNSAFE.putOrderedLong(this, C_INDEX_OFFSET, l);
    }
}
