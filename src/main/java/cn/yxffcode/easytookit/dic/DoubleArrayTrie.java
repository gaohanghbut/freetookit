 ...
 * 转换成38~73,汉字大于74(汉字转换成int后数值满园在[{@link IntsRefWrapper#CN_CHAR_FIRST},{@link IntsRefWrapper#CN_CHAR_LAST}]
...
public class DoubleArrayTrie implements Dictionary {
    ...
    public static DoubleArrayTrie create(Iterable<String> words) {
        DoubleArrayTrie trie = new DoubleArrayTrie(IntsRefWrapper.INSTANCE);
    ...
    public enum IntsRefWrapper implements AlphabetTransformer {
        INSTANCE;
        /**
         * 中文字符的起始数字
         */
